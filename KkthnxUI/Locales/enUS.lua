...
L["Caster Intro"] = "|nFilter the spell caster.|n|nplayer: Caster is the player.|n|ntarget: Caster is the target.|n|npet: Caster is the pet.|n|nAll auras will be watched if left blank."
L["Caster"] = "Caster"
...
L["Combat Intro"] = "|nIf checked, the spell will only show in combat."
L["Combat"] = "Combat"
L["CombatLog"] = "Log"
L["Combo"] = "Com"
...
L["Flash Intro"] = "|nIf checked, a highlight glow will appear on the icon when activated."
L["Flash"] = "Glow"
L["Flask"] = "Flask"
...
L["ID Intro"] = "|nSpell ID, must be a number.|n|nYou can get the ID from the spell's GameTooltip.|n|nSpell name is not supported."
L["Incomplete Input"] = "You need to complete all * options."
L["Incorrect SpellID"] = "Incorrect SpellID."
L["Install"] = "Install"
L["IntID Intro"] = "|nThe spell ID that triggers the timer, must be a number.|n|nYou can get the ID from the spell's GameTooltip.|n|nSpell name is not supported."
L["IntID*"] = "Spells*"
...
L["ItemID Intro"] = "|nThe item name of the timer that triggered.|n|nThe spell name will be used if left blank."
L["ItemID"] = "Name"
...
L["Slot Intro"] = "|nShow item slot cooldown.|n|nFor example, Engineering enchant on waist or cloak.|n|nIt only supports activated trinkets."
L["Slot*"] = "Slot*"
...
L["Stack Intro"] = "|nSpell stack, must be a number.|n|nThe spell only shows once it reaches the stack you set.|n|nThe stack will be ignored if left blank."
L["Stack"] = "Stack"
...
L["Text Intro"] = "|nShow text on spell.|n|nWhen the spell is activated, it will display the text you set.|n|nThe text will be hidden if VALUE is enabled or if left blank."
L["Text"] = "Text"
...
L["Totem Intro"] = "|nDisplays the remaining duration of the totem in its slot."
L["Totem*"] = "Totem*"
...
L["Type*"] = "Type*"
L["Unit Intro"] = "|nSpell unit information:|n|n- player: The unit is the player.|n- target: The unit is the target.|n- focus: The unit is the focus.|n- pet: The unit is the pet."
L["Unit*"] = "Unit*"
L["Value Intro"] = "|nIf checked, the spell value will be visible.|n|nFor example, a Priest's Shield will show its remaining absorb amount.|n|nThis has a higher priority than TEXT."
L["Value"] = "Value"
