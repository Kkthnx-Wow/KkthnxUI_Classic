...
local select, wipe, sort = _G.select, _G.wipe, _G.sort
local UnitClass, UnitGroupRolesAssigned = _G.UnitClass, _G.UnitGroupRolesAssigned
local StaticPopup_Hide, HideUIPanel = _G.StaticPopup_Hide, _G.HideUIPanel
