...
local Automation = function(self)
	...
	Window:CreateSwitch("Automation", "AutoKeystone", newFeatureIcon.."Automatically Place Mythic Keystones Font Of Power")
...
local Misc = function(self)
	...
	Window:CreateSwitch("Misc", "PriorityStats", "Show Stat Priority Above Character Frame")
...
local Tooltip = function(self)
	...
	Window:CreateSwitch("Tooltip", "AzeriteArmor", newFeatureIcon.."Azerite Armor Info")
	...
	Window:CreateSwitch("Tooltip", "CorruptionRank", newFeatureIcon.."Corruption Rank Info")
